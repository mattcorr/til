...
Whenever you look at installation documentation for BizTalk servers, the first step is usually a list of roles and features you need to install. For each client however, this list might be a little different based on their needs and requirements.

PowerShell makes this easy to automate by the `Install-WindowsFeature` command

!!! note
    First, ensure your servers are running at least [PowerShell 5.0](https://www.microsoft.com/en-us/download/details.aspx?id=54616).
